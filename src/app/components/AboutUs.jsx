...
function AboutUs() {
  return (
    <section id="about-us" className="text-gray-600 body-font ">
      {/* <img className="w-screen rotate-180" src="/wave21.png" alt="" /> */}
      <div className="">
          ...
          <div className="flex sm:flex-wrap flex-col md:flex-row md:flex-nowrap -m-4 text-center">
            <div className="xl:w-1/2 md:w-1/2 p-4">
              <div className="border border-black p-6 rounded-lg">
                ...
                <p className="leading-relaxed text-2xl">
                  ...
                  والذي يعمل باعلي مستوي مع فريق متميز من مهندسي الديكور
            ...
            <div className="xl:w-1/2 md:w-1/2 p-4">
              <div className="border border-black p-6 rounded-lg">
                ...
                <p className="leading-relaxed text-2xl">
                  ...
                  وبافضل الخامات, نقدم افضل الخدمات في هذا المجال ايمانا منا
                  بحركة التطور السريع الموجودة بالسوق المصري حالي
                </p>
              </div>
            </div>
            ...
            <div className="xl:w-1/2 md:w-1/2 p-4">
              <div className="border border-black p-6 rounded-lg">
                ...
                <p className="leading-relaxed text-2xl">
                  تأسسنا في عام ٢٠٢٠ و تم إنشاء هذه الشركه بعد التوسع الخيالي
                  الذي شهده السوق المصري في هذا المجال مما الهم فريق العمل
                  بالعديد من االفكار والتطلعات لتقديمها في هذا المجال
                </p>
              </div>
            </div>
          </div>
