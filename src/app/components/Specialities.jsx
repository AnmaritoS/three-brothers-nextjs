...
function Specialities() {
  return (
    <section id="specialties" class="text-gray-300 bg-[#F25A28]">
      <div class="container px-5 py-24 mx-auto flex flex-wrap">
        <div class="flex flex-wrap w-full mb-20 flex-col items-center text-center">
          <h1 class="sm:text-6xl text-4xl font-medium title-font mb-2 text-white">
            بما نتميز
          </h1>
        </div>
        <div class="flex relative pt-10 pb-20 sm:items-center md:w-2/3 mx-auto">
          <div class="h-full w-6 absolute inset-y-0 right-0 flex items-center justify-center">
            <div class="h-full w-1 bg-[#F4784E] pointer-events-none"></div>
          </div>
          <div class="flex-grow md:pr-8 pr-6 flex sm:items-center items-end flex-col-reverse sm:flex-row">
            <div class="flex-grow text-right sm:pr-6 mt-6 sm:mt-0">
              <h2 class="font-medium title-font text-white mb-1 text-2xl">
                رئيس مجلسنا
              </h2>
            ...
            <div class="flex-shrink-0 w-24 h-24 bg-indigo-100 text-orange1 rounded-full inline-flex items-center justify-center">
              <svg
          ...
          <div class="flex-shrink-0 w-6 h-6 rounded-full mt-10 sm:mt-0 inline-flex items-center justify-center bg-white text-orange1 relative z-10 title-font font-extrabold text-sm">
            1
          </div>
        </div>
